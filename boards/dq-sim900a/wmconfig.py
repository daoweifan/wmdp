...
if PLATFORM == 'gcc':
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --info sizes --info totals --info unused --info veneers --muldefweak --list dddp-stm32.map --scatter stm32_rom.sct'
    ...
    POST_ACTION = 'fromelf --bin $TARGET --output dddp-stm32.bin \nfromelf -z $TARGET'
    ...
    LFLAGS = ' --config stm32f103_md_bootloader.icf'
