...
#include "interrupt.h"
    ...
    extern const int __board_init_start;
    extern const int __board_init_end;
    extern const int __component_init_start;
    extern const int __component_init_end;
    extern const int __task_init_start;
    extern const int __task_init_end;
    extern const int __shell_cmd_start;
    extern const int __shell_cmd_end;
    extern const int __os_bg_start;
    extern const int __os_bg_end;
    extern const int __os_bg_1ms_start;
    extern const int __os_bg_1ms_end;
    extern const int __os_bg_4ms_start;
    extern const int __os_bg_4ms_end;
    extern const int __os_bg_8ms_start;
    extern const int __os_bg_8ms_end;
    extern const int __os_bg_16ms_start;
    extern const int __os_bg_16ms_end;
    extern const int __os_fg_1ms_start;
    extern const int __os_fg_1ms_end;
    extern const int __os_fg_4ms_start;
    extern const int __os_fg_4ms_end;
    extern const int __os_fg_8ms_start;
    extern const int __os_fg_8ms_end;
    extern const int __os_fg_16ms_start;
    extern const int __os_fg_16ms_end;
#else
